...
BEGIN
		...
		SELECT c.personalid, c.firstname, c.lastname, c.birthdate, c.gender, c.email, c.phone, c.address, bk.bookingdate, p.totalamount 
		FROM payment p 
...
----------------------------------------------------------------------------
-----------TRIGGER kiểm tra phòng đặt bị chồng chéo ngày với đơn khác đặt cùng phòng-------------
